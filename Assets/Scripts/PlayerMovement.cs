...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Start()
    {
        grapplingHookRenderer = gameObject.AddComponent<LineRenderer>();
        grapplingHookRenderer.startWidth = 0.1f;
        grapplingHookRenderer.endWidth = 0.1f;
        grapplingHookRenderer.startColor = Color.blue;
        grapplingHookRenderer.endColor = Color.blue;
    ...
    void Update()
    {
        ...
        else
        {
            if (Input.GetKey(KeyCode.Mouse1) && !isGrapplingHookCooldown)
            {
                ...
                if (grapplingPoint != Vector3.zero)
                {
                    ...
                    else
                    {
                        ...
                        Debug.DrawLine(handPos, grapplingPoint, Color.black);
            ...
            else
            {
                ...
                if (climbing)
                {
                    if (Input.GetKey(KeyCode.LeftShift)) Debug.Log("Shift");
